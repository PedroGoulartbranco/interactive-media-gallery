...
botao_supresa = pygame.Rect(DISTANCIA_DO_QUADRADO_DAS_IMAGENS_PARA_BOTOES, 360 + ALTURA_BOTOES, LARGURA_BOTOES, ALTURA_BOTOES)
botao_jogar = pygame.Rect(DISTANCIA_DO_QUADRADO_DAS_IMAGENS_PARA_BOTOES, 260 + ALTURA_BOTOES, LARGURA_BOTOES, ALTURA_BOTOES)

lista_botoes_principais = [botao_configuracoes, botao_editar_imagens, botao_ler, botao_supresa, botao_jogar]
...
botao_sair_jogo = pygame.Rect(0, 0, 10, 10)