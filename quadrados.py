...
botao_visao_noturna = pygame.Rect(DISTANCIA_DO_QUADRADO_DAS_IMAGENS_PARA_BOTOES, 130, LARGURA_BOTOES * 0.5, ALTURA_BOTOES_EDITAR)
botao_preto_branco = pygame.Rect(DISTANCIA_DO_QUADRADO_DAS_IMAGENS_PARA_BOTOES + botao_desenho_foto.width + 20, 130, LARGURA_BOTOES * 0.5, ALTURA_BOTOES_EDITAR)
botao_raio_x = pygame.Rect(DISTANCIA_DO_QUADRADO_DAS_IMAGENS_PARA_BOTOES, botao_desfoque_foto.y + 100, LARGURA_BOTOES * 0.5, ALTURA_BOTOES_EDITAR)
botao_psicodelico = pygame.Rect(DISTANCIA_DO_QUADRADO_DAS_IMAGENS_PARA_BOTOES + botao_vinheta_foto.width + 20, botao_desfoque_foto.y + 100, LARGURA_BOTOES * 0.5, ALTURA_BOTOES_EDITAR)

lista_botoes_especiais_editar = [botao_visao_noturna, botao_preto_branco, botao_raio_x, botao_psicodelico]